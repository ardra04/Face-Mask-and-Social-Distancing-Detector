...
root = Tk()
root.title('EPS TRACKING SYSTEM')
...
my_label = HTMLLabel(root, html="""
    <ul>
        <a href='C:\\Users\\kbraj\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Python 3.10\\HTML frontend\\index.html'>Click here to go to our EPS webpage</a>
        <p>Else you can close this window to enable our Monitoring System<p>
    </ul>
    """)
